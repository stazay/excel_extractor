...
(a) First, sheet_index:2 of workbook_2 is searched for matches of the `dataframe[queried_df_index]` (3rd index in the dataframe and column F from workbook_1). 
...
This is using workbook_3, sheet_index:8, extracting information from columns F and H, by searching for a match in the `dataframe[queried_df_index]` (3rd index in the dataframe and column F from workbook_1).
...
(c) Finally, sheet_index:1 of workbook_3 is searched for matches of the `dataframe[queried_df_index]` (3rd index in the dataframe and column F from workbook_1).
